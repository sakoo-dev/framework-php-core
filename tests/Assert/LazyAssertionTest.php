...
{
	#[Test]
	public function assert_lazy_is_instance_of_lazy_assertion()
	{
	...
	#[Test]
	public function lazy_assertion_makes_a_chain()
	{
	...
	#[Test]
	public function lazy_assertion_can_use_assertion_chain()
	{
		$this->expectException(LazyAssertionException::class);
