...
final class AssertTest extends TestCase
{
	...
	public function it_type_assertions_work_properly($function, $valid, $invalid, $message)
	{
	...
	public function it_complex_assertions_work_properly($function, $valid, $invalid, $message)
	{
		foreach ($valid as $item) {
			Assert::$function(...$item);
		}
	...
	#[Test]
	public function it_length_assertion_works_properly()
	{
		$valid = [['ABCDEF', 6]];
		$invalid = [['ABCDEF', 7]];
	...
	#[Test]
	public function it_count_assertion_works_properly()
	{
		$valid = [[['A', 'B', 'C'], 3]];
		$invalid = [[['A', 'B', 'C'], 2]];
	...
	public function it_permission_assertions_work_properly($function, $valid, $invalid, $message)
	{
	...
	#[Test]
	public function it_symlink_assertions_work_properly()
	{
	...
	#[Test]
	public function it_upload_file_assertions_work_properly()
	{
		$file = $this->makeTemporaryFile();
