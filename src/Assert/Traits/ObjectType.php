...
trait ObjectType
{
	...
	{
		$message = $message ?: sprintf('Given value %s is not instance of %s', new VarDump($value), $class);
	...
	{
		$message = $message ?: sprintf('Given value %s is instance of %s', new VarDump($value), $class);
